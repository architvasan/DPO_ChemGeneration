...
class CustomDataset(Dataset):
    def __init__(self, tokenizer, data, y_regression_values, max_input_length, max_target_length, device="xpu"):
...
class CustomDataset_inf(Dataset):
