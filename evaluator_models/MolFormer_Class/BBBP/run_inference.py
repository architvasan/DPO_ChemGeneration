...
from data_utils import CustomDataset_inf
...
test_set = CustomDataset_inf(tokenizer, data[args.smilescol].tolist(), max_input_length=512, max_target_length=512)
...
checkpoint = torch.load(args.modelcheckpoint, map_location=torch.device('cpu'))
...
outputs_dict = inference_test_set(0)
